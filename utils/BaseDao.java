...
public class BaseDao {
    ...
    //需要生成mapper文件的sql语句
    private static String sql = "SELECT * FROM produce_report pr JOIN base_flow bf ON pr.flowid=bf.flowid JOIN base_company bc ON pr.compid=bc.compid";
    //主表
    private static String mainTable = "produce_report";
